...
int main(int argc, char *argv[]) {
    ...
    unsigned int min_temp = weather_min_temp(array);
    printf("\nThe min temp is: %d\n", min_temp);

    /* output2 with the highest maximum temperature */
    weather_max_temp(array, output2);

    /* output3 the months with the highest monthly amount of rainfall */
    weather_max_rainfall(array, output3);

    array_dump_maxTemp(output2);
    array_dump_month(output3);
